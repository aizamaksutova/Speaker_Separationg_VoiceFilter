...
class MyWriter(SummaryWriter):
    ...
    def log_training(self, train_loss, si_sdr,
                       mixed_wav, target_wav, est_wav,
                       mixed_spec, target_spec, est_spec, est_mask, lr,
                       step):
        self.add_scalar('train_loss', train_loss, step)
        self.add_scalar('SI-SDR', si_sdr, step)
    ...
    def log_evaluation(self, test_loss, si_sdr,
                       mixed_wav, target_wav, est_wav,
